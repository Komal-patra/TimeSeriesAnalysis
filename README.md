...
Index Terms—Exponential Smoothing, ARIMA, Moving Average, Holt’s Linear, Trend, Seasonal, Accuracy, Root Mean square error, Akaike Information criterion (AIC), Bayesian Information criterion (BIC), Logistic model, Precision, Recall
